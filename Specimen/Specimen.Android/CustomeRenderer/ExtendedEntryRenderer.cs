...
using Specimen;
using Specimen.Droid.CustomeRenderer;
...
namespace Specimen.Droid.CustomeRenderer
{
    public class ExtendedEntryRenderer : EntryRenderer
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Entry> e)
        {
            ...
            Control.Background = this.Resources.GetDrawable(Resource.Drawable.txtBorder);
            //Control.SetBackgroundDrawable(Resources.GetDrawable(Resource.Drawable.txtBorder));
